...
{
    switch (magic) {
    case _L(0401):  return "PDP-11 (UNIX-rt ldp)";
    case _L(0405):  return "PDP-11 (Overlay)";
    case _L(0407):  return "PDP-11 (System V vax executable)";
    case _L(0410):  return "PDP-11 (System V vax pure executable)";
    case _L(0411):  return "PDP-11 (Seperate I&D)";
    case _L(0437):  return "PDP-11 (Kernel overlay)";
...
//  case _L(0524):  return "National Semiconductor 32000 (Readonly shareable text segments)";
    ...
    case _L(0530):  return "IBM 370 (Writeble text segments)";
    case _L(0532):  return "IBM 370 (Reserved)";
    case _L(0533):  return "IBM 370 (Reserved)";
    case _L(0535):  return "IBM 370 (Readonly sharable text segments)";
    ...
    case _L(0550):  return "3B20, no TV";
    case _L(0551):  return "3B20 with TV";
    ...
    case _L(0570):  return "VAX-11 (Writable text segments)";
    case _L(0571):  return "VAX-11 (Readonly sharable text segments)";
    }
