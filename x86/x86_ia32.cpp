...
//------------------------------------------------------------------------------
const x86_instruction::instruction_pointer x86_ia32::group[18][8] =
{        // 0             1           2           3           4       5        6        7
...
/* 12 */{ o _           x _         x PSRLW     x _         x PSRAW x _      x PSLLW  x _      },
/* 13 */{ o _           x _         x PSRLD     x _         x PSRAD x _      x PSLLD  x _      },
/* 14 */{ o _           x _         x PSRLQ     x _         x _     x _      x PSLLQ  x _      },
/* 15 */{ o _           x _         x LDMXCSR   x STMXCSR   x _     x LFENCE x MFENCE x SFENCE },
/* 16 */{ o PREFETCHNTA x PREFETCH0 x PREFETCH1 x PREFETCH2 x _     x _      x _      x _      },
};
//------------------------------------------------------------------------------
const x86_instruction::instruction_pointer x86_ia32::group66[18][8] =
{        // 0             1           2           3           4       5        6        7
/*  0 */{ o _           x _         x _         x _         x _     x _      x _      x _      },
/*  1 */{ o _           x _         x _         x _         x _     x _      x _      x _      },
/*  2 */{ o _           x _         x _         x _         x _     x _      x _      x _      },
/*  3 */{ o _           x _         x _         x _         x _     x _      x _      x _      },
/*  4 */{ o _           x _         x _         x _         x _     x _      x _      x _      },
/*  5 */{ o _           x _         x _         x _         x _     x _      x _      x _      },
/*  6 */{ o _           x _         x _         x _         x _     x _      x _      x _      },
/*  7 */{ o _           x _         x _         x _         x _     x _      x _      x _      },
/*  8 */{ o _           x _         x _         x _         x _     x _      x _      x _      },
/*  9 */{ o _           x _         x _         x _         x _     x _      x _      x _      },
/* 10 */{ o _           x _         x _         x _         x _     x _      x _      x _      },
/* 11 */{ o _           x _         x _         x _         x _     x _      x _      x _      },
/* 12 */{ o _           x _         x PSRLW     x _         x PSRAW x _      x PSLLW  x _      },
/* 13 */{ o _           x _         x PSRLD     x _         x PSRAD x _      x PSLLD  x _      },
/* 14 */{ o _           x _         x PSRLQ     x PSRLDQ    x _     x _      x PSLLQ  x PSLLDQ },
/* 15 */{ o _           x _         x _         x _         x _     x _      x _      x _      },
/* 16 */{ o _           x _         x _         x _         x _     x _      x _      x _      },
};
//------------------------------------------------------------------------------
// Escape Opcode Map
//------------------------------------------------------------------------------
