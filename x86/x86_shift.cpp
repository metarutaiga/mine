...
//------------------------------------------------------------------------------
void x86_instruction::Sxx(Format& format)
{
    switch (opcode[0]) {
    case 0xC0:
    case 0xC1:
        switch (opcode[1] >> 3 & 7) {
        case 4: Decode(format, "SHL", 1, 8, opcode[0] & 0b01);  break;
        case 5: Decode(format, "SHR", 1, 8, opcode[0] & 0b01);  break;
        case 6: Decode(format, "SAL", 1, 8, opcode[0] & 0b01);  break;
        case 7: Decode(format, "SAR", 1, 8, opcode[0] & 0b01);  break;
        }
        break;
    case 0xD0:
    case 0xD1:
        switch (opcode[1] >> 3 & 7) {
        case 4: Decode(format, "SHL", 1, 0, opcode[0] & 0b01);  break;
        case 5: Decode(format, "SHR", 1, 0, opcode[0] & 0b01);  break;
        case 6: Decode(format, "SAL", 1, 0, opcode[0] & 0b01);  break;
        case 7: Decode(format, "SAR", 1, 0, opcode[0] & 0b01);  break;
        }
...
//------------------------------------------------------------------------------
void x86_instruction::SHxD(Format& format)
{
    switch (opcode[1]) {
    case 0xA4:
