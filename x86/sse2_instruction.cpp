...
void sse2_instruction::CMPPD(Format& format, const uint8_t* opcode)
{
    ...
    case 0: BEGIN_OPERATION() { DEST.i64 = (DEST.f64 == SRC.f64);   } END_OPERATION_SSE;    break;
    case 1: BEGIN_OPERATION() { DEST.i64 = (DEST.f64 < SRC.f64);    } END_OPERATION_SSE;    break;
    case 2: BEGIN_OPERATION() { DEST.i64 = (DEST.f64 <= SRC.f64);   } END_OPERATION_SSE;    break;
    case 3:
        BEGIN_OPERATION() {
        ...
        break;
    case 4: BEGIN_OPERATION() { DEST.i64 = (DEST.f64 != SRC.f64);   } END_OPERATION_SSE;    break;
    case 5: BEGIN_OPERATION() { DEST.i64 = (DEST.f64 >= SRC.f64);   } END_OPERATION_SSE;    break;
    case 6: BEGIN_OPERATION() { DEST.i64 = (DEST.f64 > SRC.f64);    } END_OPERATION_SSE;    break;
    case 7:
        BEGIN_OPERATION() {
...
void sse2_instruction::CMPSD(Format& format, const uint8_t* opcode)
{
    ...
    switch (format.operand[2].displacement) {
    case 0: BEGIN_OPERATION() { DEST.i64[0] = (DEST.f64[0] == SRC.f64[0]) ? -1 : 0;                     } END_OPERATION_SSE;    break;
    case 1: BEGIN_OPERATION() { DEST.i64[0] = (DEST.f64[0] < SRC.f64[0]) ? -1 : 0;                      } END_OPERATION_SSE;    break;
    case 2: BEGIN_OPERATION() { DEST.i64[0] = (DEST.f64[0] <= SRC.f64[0]) ? -1 : 0;                     } END_OPERATION_SSE;    break;
    case 3: BEGIN_OPERATION() { DEST.i64[0] = isunordered(DEST.f64[0], SRC.f64[0]) ? -1 : 0;            } END_OPERATION_SSE;    break;
    case 4: BEGIN_OPERATION() { DEST.i64[0] = (DEST.f64[0] != SRC.f64[0]) ? -1 : 0;                     } END_OPERATION_SSE;    break;
    case 5: BEGIN_OPERATION() { DEST.i64[0] = (DEST.f64[0] >= SRC.f64[0]) ? -1 : 0;                     } END_OPERATION_SSE;    break;
    case 6: BEGIN_OPERATION() { DEST.i64[0] = (DEST.f64[0] > SRC.f64[0]) ? -1 : 0;                      } END_OPERATION_SSE;    break;
    case 7: BEGIN_OPERATION() { DEST.i64[0] = isunordered(DEST.f64[0], SRC.f64[0]) == false ? -1 : 0;   } END_OPERATION_SSE;    break;
    }
}
//------------------------------------------------------------------------------
...
void sse2_instruction::CVTPD2DQ(Format& format, const uint8_t* opcode)
{
    ...
    BEGIN_OPERATION() {
        ...
        case RoundNearest:
            DEST.i32 = {
                int32_t(round(SRC.f64[0])),
                int32_t(round(SRC.f64[1])),
            };
            break;
        case RoundDown:
            DEST.i32 = {
                int32_t(floor(SRC.f64[0])),
                int32_t(floor(SRC.f64[1])),
            };
            break;
        case RoundUp:
            DEST.i32 = {
                int32_t(ceil(SRC.f64[0])),
                int32_t(ceil(SRC.f64[1])),
            };
            break;
        case RoundChop:
            DEST.i32 = {
                int32_t(trunc(SRC.f64[0])),
                int32_t(trunc(SRC.f64[1])),
            };
            break;
        }
    } END_OPERATION_SSE;
    ...
    BEGIN_OPERATION() {
        ...
        case RoundNearest:
            DEST.i32 = {
                ...
                int32_t(roundf(SRC.f32[2])),
                int32_t(roundf(SRC.f32[3])),
            };
            break;
        case RoundDown:
            DEST.i32 = {
                ...
                int32_t(floorf(SRC.f32[2])),
                int32_t(floorf(SRC.f32[3])),
            };
            break;
        case RoundUp:
            DEST.i32 = {
                ...
                int32_t(ceilf(SRC.f32[2])),
                int32_t(ceilf(SRC.f32[3])),
            };
            break;
        case RoundChop:
            DEST.i32 = {
                ...
                int32_t(truncf(SRC.f32[2])),
                int32_t(truncf(SRC.f32[3])),
            };
            break;
        }
    } END_OPERATION_SSE;
...
void sse2_instruction::MAXSD(Format& format, const uint8_t* opcode)
{
    ...
    BEGIN_OPERATION() {
        DEST.f64[0] = Max(DEST.f64[0], SRC.f64[0]);
    } END_OPERATION_SSE;
}
//------------------------------------------------------------------------------
...
void sse2_instruction::MINSD(Format& format, const uint8_t* opcode)
{
    ...
    BEGIN_OPERATION() {
        DEST.f64[0] = Min(DEST.f64[0], SRC.f64[0]);
    } END_OPERATION_SSE;
}
//------------------------------------------------------------------------------
...
void sse2_instruction::PACKSSDW(Format& format, const uint8_t* opcode)
{
    ...
    BEGIN_OPERATION() {
        DEST.i16 = {
            ...
            int16_t(Saturate(DEST.i32[2], INT16_MIN, INT16_MAX)),
            int16_t(Saturate(DEST.i32[3], INT16_MIN, INT16_MAX)),
            int16_t(Saturate(SRC.i32[2], INT16_MIN, INT16_MAX)),
            int16_t(Saturate(SRC.i32[3], INT16_MIN, INT16_MAX)),
        };
    } END_OPERATION_SSE;
}
//------------------------------------------------------------------------------
void sse2_instruction::PACKSSWB(Format& format, const uint8_t* opcode)
{
    ...
    BEGIN_OPERATION() {
        DEST.i8 = {
            ...
            int8_t(Saturate(DEST.i16[4], INT8_MIN, INT8_MAX)),
            int8_t(Saturate(DEST.i16[5], INT8_MIN, INT8_MAX)),
            int8_t(Saturate(DEST.i16[6], INT8_MIN, INT8_MAX)),
            int8_t(Saturate(DEST.i16[7], INT8_MIN, INT8_MAX)),
            int8_t(Saturate(SRC.i16[4], INT8_MIN, INT8_MAX)),
            int8_t(Saturate(SRC.i16[5], INT8_MIN, INT8_MAX)),
            int8_t(Saturate(SRC.i16[6], INT8_MIN, INT8_MAX)),
            int8_t(Saturate(SRC.i16[7], INT8_MIN, INT8_MAX)),
        };
    } END_OPERATION_SSE;
}
//------------------------------------------------------------------------------
void sse2_instruction::PACKUSWB(Format& format, const uint8_t* opcode)
{
    ...
    BEGIN_OPERATION() {
        DEST.u8 = {
            ...
            uint8_t(Saturate(DEST.i16[4], 0, UINT8_MAX)),
            uint8_t(Saturate(DEST.i16[5], 0, UINT8_MAX)),
            uint8_t(Saturate(DEST.i16[6], 0, UINT8_MAX)),
            uint8_t(Saturate(DEST.i16[7], 0, UINT8_MAX)),
            uint8_t(Saturate(SRC.i16[4], 0, UINT8_MAX)),
            uint8_t(Saturate(SRC.i16[5], 0, UINT8_MAX)),
            uint8_t(Saturate(SRC.i16[6], 0, UINT8_MAX)),
            uint8_t(Saturate(SRC.i16[7], 0, UINT8_MAX)),
        };
    } END_OPERATION_SSE;
}
//------------------------------------------------------------------------------
...
void sse2_instruction::PAVGB(Format& format, const uint8_t* opcode)
{
    ...
    BEGIN_OPERATION() {
        DEST.u8 = {
            ...
            uint8_t((DEST.u8[8] + SRC.u8[8]) / 2),
            uint8_t((DEST.u8[9] + SRC.u8[9]) / 2),
            uint8_t((DEST.u8[10] + SRC.u8[10]) / 2),
            uint8_t((DEST.u8[11] + SRC.u8[11]) / 2),
            uint8_t((DEST.u8[12] + SRC.u8[12]) / 2),
            uint8_t((DEST.u8[13] + SRC.u8[13]) / 2),
            uint8_t((DEST.u8[14] + SRC.u8[14]) / 2),
            uint8_t((DEST.u8[15] + SRC.u8[15]) / 2),
        };
    } END_OPERATION_SSE;
}
//------------------------------------------------------------------------------
void sse2_instruction::PAVGW(Format& format, const uint8_t* opcode)
{
    ...
    BEGIN_OPERATION() {
        DEST.u16 = {
            ...
            uint16_t((DEST.u16[4] + SRC.u16[4]) / 2),
            uint16_t((DEST.u16[5] + SRC.u16[5]) / 2),
            uint16_t((DEST.u16[6] + SRC.u16[6]) / 2),
            uint16_t((DEST.u16[7] + SRC.u16[7]) / 2),
        };
    } END_OPERATION_SSE;
}
//------------------------------------------------------------------------------
...
void sse2_instruction::PMADDWD(Format& format, const uint8_t* opcode)
{
    ...
    BEGIN_OPERATION() {
        DEST.i32 = {
            ...
            DEST.i16[4] * SRC.i16[4] + DEST.i16[5] * SRC.i16[5],
            DEST.i16[6] * SRC.i16[6] + DEST.i16[7] * SRC.i16[7],
        };
    } END_OPERATION_SSE;
}
//------------------------------------------------------------------------------
...
void sse2_instruction::PMULHUW(Format& format, const uint8_t* opcode)
{
    ...
    BEGIN_OPERATION() {
        DEST.u16 = {
            ...
            uint16_t((DEST.u16[4] * SRC.u16[4]) >> 16),
            uint16_t((DEST.u16[5] * SRC.u16[5]) >> 16),
            uint16_t((DEST.u16[6] * SRC.u16[6]) >> 16),
            uint16_t((DEST.u16[7] * SRC.u16[7]) >> 16),
        };
    } END_OPERATION_SSE;
}
//------------------------------------------------------------------------------
void sse2_instruction::PMULHW(Format& format, const uint8_t* opcode)
{
    ...
    BEGIN_OPERATION() {
        DEST.i16 = {
            ...
            int16_t((DEST.i16[4] * SRC.i16[4]) >> 16),
            int16_t((DEST.i16[5] * SRC.i16[5]) >> 16),
            int16_t((DEST.i16[6] * SRC.i16[6]) >> 16),
            int16_t((DEST.i16[7] * SRC.i16[7]) >> 16),
        };
    } END_OPERATION_SSE;
}
//------------------------------------------------------------------------------
...
void sse2_instruction::PSADBW(Format& format, const uint8_t* opcode)
{
    ...
    BEGIN_OPERATION() {
        DEST.u16 = {
            ...
            0,
            0,
            uint16_t(abs(DEST.u8[8] - SRC.u8[8]) +
                     abs(DEST.u8[9] - SRC.u8[9]) +
                     abs(DEST.u8[10] - SRC.u8[10]) +
                     abs(DEST.u8[11] - SRC.u8[11]) +
                     abs(DEST.u8[12] - SRC.u8[12]) +
                     abs(DEST.u8[13] - SRC.u8[13]) +
                     abs(DEST.u8[14] - SRC.u8[14]) +
                     abs(DEST.u8[15] - SRC.u8[15])),
            0,
            0,
            0,
        };
