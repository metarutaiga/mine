...
//  { "RaiseException",             INT32(4, 0)                                                     },
    ...
    { "GetModuleBaseNameW",         INT32(4, syscall_GetModuleBaseNameW(memory, stack))             },
    { "GetModuleFileNameA",         INT32(3, syscall_GetModuleFileNameA(memory, stack))             },
    { "GetModuleFileNameW",         INT32(3, syscall_GetModuleFileNameW(memory, stack))             },
    ...
    { "GetTickCount",               INT32(0, syscall_GetTickCount64())                              },
