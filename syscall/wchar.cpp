...
static std::wstring convert_format(const wchar_t* format)
{
    size_t pos;
...
static std::vector<uint64_t> convert_format_argument(const wchar_t* format, const void* memory, const void* stack)
{
